...
public class TaiKhoanBUS {
    ...
    public String getTenDangNhapTheoMa(String ma) {
        ...
        return taiKhoanDAO.getTaiKhoanTheoMa(maNV);
    }
    ...
    public boolean themTaiKhoan(String ma, String tenDangNhap, String matKhau) {
        int maNV = Integer.parseInt(ma);
        ...
        boolean flag = taiKhoanDAO.themTaiKhoan(maNV, tenDangNhap, matKhau);
        if (flag) {
